# This is an old script that was used for one study to extract call history out of an iphone from 
# a specific 3rd party program.  The data it generates matches android call history data.
