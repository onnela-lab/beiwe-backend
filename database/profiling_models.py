...
class S3File(TimestampedModel):
    ...
    compression_time_us = models.PositiveIntegerField(null=True, blank=True)
    decompression_time_us = models.PositiveIntegerField(null=True, blank=True)
    encryption_time_us = models.PositiveIntegerField(null=True, blank=True)
    download_time_us = models.PositiveIntegerField(null=True, blank=True)
    upload_time_us = models.PositiveIntegerField(null=True, blank=True)
    decrypt_time_us = models.PositiveIntegerField(null=True, blank=True)
